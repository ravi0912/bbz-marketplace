        ...
        <div class="col-md-6">
            ...
            <div id="outer_container">
                <div id="inner_container">
                    <h6 style="color:#6262ff;font-weight:bold;margin-top:-12px;">{{ $product->category->name }} > {{ $product->subcategory->name }} > {{ $product->name }}</h6>
                    <div class="upper">
                        ...
                        <div class="lower_left">
                            <div style="padding-left:7px">
                                ...
                                <ul style="margin-top:-10px;margin-left:-40px">
                                    @foreach($product->filters as $filter)
                                        <li><span style="color:#6262ff">{{ $filter->filterName->name }}</span> : <strong>{{ $filter->data }}</strong></li>
                                    @endforeach
